    ...
    public class RegisterValidator : AbstractValidator<RegisterUserDto>
    {
        public RegisterValidator()
        {
            RuleFor(x => x.username)
                ...
                .Must(username => Regex.IsMatch(username, Const.RGX_USERNAME, RegexOptions.None, TimeSpan.FromSeconds(5))).WithMessage("Tên tài khoản chỉ được chứa số và chữ cái");
