...
namespace CodeDesign.ES
{
    ...
    {
        protected static Uri node = new Uri(Utils.ConfigurationManager.AppSettings["ES:Server"]);
        protected static string prefix_index = Utils.ConfigurationManager.AppSettings["ES:Prefix"];
